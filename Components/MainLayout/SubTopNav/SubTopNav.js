      ...
      <div className={`centerFlex adjustMargin ${navTopSt.header_info}`}>
        ...
        <div className={` centerFlex ${navTopSt.header_currence_main } `}>
          ...
          <div className={ ` ${navTopSt.myaccount_main}`}>
            ...
            <Link href="#" className="centerEL"><img src="/iconImg/icons8-user-64.png" alt="" /> <h4>My Account</h4></Link>
          </div>
          <div className={navTopSt.myaccount_main}>
            <Link href="#"  className="centerEL"><img src="/iconImg/icons8-sign-in-96.png" alt="" /> <h4>Sign in/Register</h4></Link>
          </div>
